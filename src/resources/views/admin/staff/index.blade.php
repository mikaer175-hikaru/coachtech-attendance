...
<main class="staff-list" aria-labelledby="staff-list-title">
        ...
        <table class="staff-list__table">
            <thead class="staff-list__thead">
                <tr class="staff-list__row">
                    <th class="staff-list__cell staff-list__cell--head">氏名</th>
                    <th class="staff-list__cell staff-list__cell--head">メールアドレス</th>
                    <th class="staff-list__cell staff-list__cell--head staff-list__cell--action">操作</th>
                </tr>
            </thead>
                ...
                @forelse ($users as $user)
                    <tr class="staff-list__row">
                        ...
                        <td class="staff-list__cell staff-list__cell--action">
                            {{-- 月次勤怠一覧（PG11想定: /admin/attendance/staff/{id}?month=YYYY-MM） --}}
                            <a class="staff-list__detail-button"
